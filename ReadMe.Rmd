...
Maintainers of `MOrepo` are Lars Relund Nielsen, Thomas Stridsen and Kim Allan Andersen. Maintainers of instance sets and resluts are  `r paste0(getMaintainers(), collapse=", ")`. Current contributors to the repository are `r paste0(getContributors(), collapse=", ")`. 
