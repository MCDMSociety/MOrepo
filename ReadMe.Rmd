...
Current contributors to the repository are `r vec2String(getContributorNames())`. An overview over all contributions can be seen at [`repoOverview.md`](repoOverview.md).
